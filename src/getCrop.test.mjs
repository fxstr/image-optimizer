...
test('uses focal point', () => {
    expect(getCrop(createParams(200, 100, 25, 50, 120, 0))).toEqual(createOutputParams(95, 0, 145, 100));
    // Does not go beyond image's borders
    expect(getCrop(createParams(200, 100, 25, 50, 200, 0))).toEqual(createOutputParams(150, 0, 200, 100));
    expect(getCrop(createParams(200, 100, 25, 50, -10, 0))).toEqual(createOutputParams(0, 0, 50, 100));
